          ...
          <WidthBlock>
            ...
            >
              <ul>
                ...
                <li>
                  <Link to="/cases" onClick={toggleMenu}>КЕЙСЫ</Link>
                </li>
                <li>
                  <Link to="/shop" onClick={toggleMenu}>МАГАЗИН</Link>
                </li>
                <li>
                  <Link to="/information" onClick={toggleMenu}>О НАС</Link>
                </li>
                <li>
            ...
            <ul className={classes.navigate}>
              ...
              <li><img src="/images/Logo.png" alt="Логотип" onClick={() => navigate('/')} /></li>
              <li><Link to="/shop">МАГАЗИН</Link></li>
              <li><Link to="/information">О НАС</Link></li>
