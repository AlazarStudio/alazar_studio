  ...
  return (
    <>
      <div className={classes.container}>
        ...
        <img src="/images/Advocate2.png" style={{ transform: `translateY(${scrollY * 0.03}px)` }}/>
        <img src="/images/Advocate3.png" style={{ transform: `translateY(${scrollY * 0.03}px)` }}/>
        <img src="/images/Advocate4.png" style={{ transform: `translateY(${scrollY * 0.03}px)` }}/>
        <img src="/images/Advocate5.png" style={{ transform: `translateY(${scrollY * -0.03}px)` }}/>
        <img src="/images/Advocate7.png" style={{ transform: `translateY(${scrollY * 0.03}px)` }}/>
