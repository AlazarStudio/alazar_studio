      ...
      <div className={classes.ContainerMedia}>
        <div className={classes.ContainerMediaRight}>
          <img
            src="/images/iPhone11.png"
            alt=""
            style={{ transform: `translateY(${scrollY * -0.18}px)` }} // Движение вверх
          />
          <img
            src="/images/iPhone22.png"
            alt=""
            style={{ transform: `translateY(${scrollY * 0.22}px)` }} // Движение вниз
          />
          <img
            src="/images/iPhone33.png"
            alt=""
            style={{ transform: `translateY(${scrollY * -0.21}px)` }} // Движение вверх
          />
        </div>
