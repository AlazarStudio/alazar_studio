          ...
          <div className={classes.containerTopService}>
            ...
            <div className={classes.containerTopServiceElements}>
              ...
              <div className={classes.containerTopServiceElementsRight}>
                ...
                <span className={classes.grayText}>грамоты, сертификаты, визитки,
пригласительные, пакеты, ручки,
бейджи, блокноты, магниты и т.п</span>
                <div className={classes.containerTopServiceElementsItem}>
                  <img src="/images/Ellipse 28.png" />
                  <span>Социальные сети</span>
                </div>
                <span className={classes.grayText}>посты, сторис, визитные карточки
профилей, обложки для каналов
или групп, баннеры </span>
                <div className={classes.containerTopServiceElementsItem}>
                  <img src="/images/Ellipse 28.png" />
                  <span>UX/UI </span>
                </div>
