  ...
  return (
    <>
      <div className={classes.container}>
        ...
        <img src="/images/Advocate4.png" style={{ transform: `translateY(${scrollY * 0.01}px)` }}/>
        <img src="/images/Advocate5.png" style={{ transform: `translateY(${scrollY * -0.27}px)` }}/>
        <img src="/images/Advocate7.png" style={{ transform: `translateX(${scrollY * -0.26}px)` }}/>
