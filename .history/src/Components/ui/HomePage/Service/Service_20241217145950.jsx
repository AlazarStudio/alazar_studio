      ...
      <div className={classes.container}>
        ...
        <div className={classes.containerRight}>
          ...
          <div className={classes.containerRightBottom}>
            ...
            <div className={classes.containerRightBottomRight}>
            <div className={classes.containerRightBotoomLeftBlock}>
                <span className={classes.containerRightBotoomLeftBlock1}>04</span>
                <span className={classes.containerRightBotoomLeftBlock2}>Презентации </span>
              </div>
              <div className={classes.containerRightBotoomLeftBlock}>
                <span className={classes.containerRightBotoomLeftBlock1}>05</span>
                <span className={classes.containerRightBotoomLeftBlock2}>Рекламная продукция</span>
              </div>
              <div className={classes.containerRightBotoomLeftBlock}>
                <span className={classes.containerRightBotoomLeftBlock1}>06</span>
                <span className={classes.containerRightBotoomLeftBlock2}>Видео-ПРОДАКШН</span>
              </div>
            </div>
          </div>
        </div>
