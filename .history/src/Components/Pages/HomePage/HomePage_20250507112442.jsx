...
export default function HomePage() {
  ...
  // Фильтруем кейсы по выбранной категории по title
  const filteredCaseHomes = categoryTitle
    ? caseHomes.filter((caseHome) =>
        caseHome.categories.some((category) => category.title.toLowerCase() === categoryTitle.toLowerCase()) // Сравниваем title как строку
      )
    : caseHomes;
