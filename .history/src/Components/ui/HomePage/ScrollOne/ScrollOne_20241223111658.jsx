...
function ScrollOne() {
  ...
  return (
    <>
      ...
      <div
        className={classes.containerMedia}
        ref={containerRef}
        onWheel={handleWheel}
        {...swipeHandlers} // Добавление обработчиков свайпов
      >
        <img src="/images/wm1.png" alt="Image 1" />
        <img src="/images/bm1.png" alt="Image 2" />
        <img src="/images/wm2.png" alt="Image 3" />
        <img src="/images/bm2.png" alt="Image 4" />
        <img src="/images/wm3.png" alt="Image 5" />
      </div>
    </>
  );
}
